...
Run* createOptimizedRun(Demand* demandas[], int indices[], int count, double gamma) {
    ...
    if (count == 1) {
        ...
        //  Corrida individual é 1 trecho de DESLOCAMENTO (TRANS_PATH) 
        ...
        for (int i = 1; i < numStops; i++) {
            ...
            // Identificar os 3 tipos de trecho 
            Path_Type type;
            if (i < count) {
...
int main(int argc, char *argv[]) {
    ...
    *input_stream >> n;
    ...
    for (int j = i + 1; j < n && groupSize < eta; j++) {
            ...
            // Usamos a função de rota básica
